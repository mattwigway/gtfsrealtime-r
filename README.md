...
See [this vignette](https://projects.indicatrix.org/gtfsrealtime-r/articles/archived.html) for a walkthrough of working with vehicle position feeds. Working with alerts and trip updates is similar; see the documentation for the relevant functions in the Reference tab.
>>>>>>> c87ba33 ((aspirational) instructions to install from CRAN)
