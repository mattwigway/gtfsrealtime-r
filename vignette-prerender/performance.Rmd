...
`gtfsrealtime` is more than two orders of magnitude faster than an RProtoBuf workflow using standard R data processing tools. `gtfsrealtime` is also more user-friendly, as a single line of code reads a whole day of data and formats it as a data frame.
