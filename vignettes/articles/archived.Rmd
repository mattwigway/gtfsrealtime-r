...
## 1 MTA NYCT_7116 40.65841 -73.90079 204.64677       NA    NA
## 2 MTA NYCT_8447 40.65276 -73.73687  87.46083       NA    NA
## 3 MTA NYCT_9760 40.82083 -73.93955  52.98173       NA    NA
## 4 MTA NYCT_7102 40.66895 -73.91563 187.95752       NA    NA
## 5 MTA NYCT_8481 40.62516 -74.14923 173.41806       NA    NA
## 6 MTA NYCT_5314 40.85237 -73.88198 254.32916       NA    NA
##                              trip_id route_id direction_id start_time
## 1  EN_A6-Weekday-SDon-021000_B15_103      B15            1       <NA>
## 2  JA_A6-Weekday-SDon-019500_Q86_653      Q86            1       <NA>
## 3   MV_A6-Weekday-SDon-019400_M2_202       M2            0       <NA>
## 4    EN_A6-Weekday-SDon-023000_B12_1      B12            1       <NA>
## 5 CA_A6-Weekday-SDon-021000_S4898_71      S48            1       <NA>
## 6 WF_A6-Weekday-SDon-019500_BX19_301     BX19            1       <NA>
##   start_date schedule_relationship stop_id current_stop_sequence current_status
## 1   20260128                  <NA>  301050                    NA           <NA>
## 2   20260128                  <NA>  700896                    NA           <NA>
## 3   20260128                  <NA>  400241                    NA           <NA>
## 4   20260128                  <NA>  301594                    NA           <NA>
## 5   20260128                  <NA>  201566                    NA           <NA>
## 6   20260128                  <NA>  100642                    NA           <NA>
##             timestamp congestion_level     occupancy_status
## 1 2026-01-28 03:55:53             <NA> MANY_SEATS_AVAILABLE
## 2 2026-01-28 03:56:09             <NA>                 <NA>
## 3 2026-01-28 03:56:06             <NA> MANY_SEATS_AVAILABLE
## 4 2026-01-28 03:55:52             <NA>                 <NA>
## 5 2026-01-28 03:55:59             <NA>                 <NA>
## 6 2026-01-28 03:55:58             <NA>                 <NA>
##   occupancy_percentage    vehicle_id vehicle_label vehicle_license_plate
## 1                   NA MTA NYCT_7116          <NA>                  <NA>
## 2                   NA MTA NYCT_8447          <NA>                  <NA>
## 3                   NA MTA NYCT_9760          <NA>                  <NA>
## 4                   NA MTA NYCT_7102          <NA>                  <NA>
## 5                   NA MTA NYCT_8481          <NA>                  <NA>
## 6                   NA MTA NYCT_5314          <NA>                  <NA>
...
Note that, at least in the New York data, there are sometimes multiple reports with the same timestamp and vehicle ID but different locations. This is some type of data error, so I just arbitrarily pick one.
...
<div class="figure">
<img src="figures/unnamed-chunk-8-1.png" alt="Plot showing several thousand dots representing buses, in the general shape of New York City, on a white background."  />
...
```
## Error in `gifski()`:
## ! Target directory does not exist:figures
```
...
<div class="figure">
<img src="figures/unnamed-chunk-14-1.png" alt="Trajectories of all trips showing the bus network of NYC as a bunch of lines, one for the path taken by each vehicle, on a white background."  />
...
<div class="figure">
<img src="figures/unnamed-chunk-15-1.png" alt="A single vehicle's trajectory, a line from southeast to northwest."  />
...
<div class="figure">
<img src="figures/unnamed-chunk-16-1.png" alt="The same trajectory, but now with times along it; it starts at 5:47 and ends at 6:18"  />
