...
#'         in GTFS `frequencies.txt`. (path: `informed_entity.trip.trip_start_date`)
#'   - `trip_schedule_relationship`: The relation between this trip and the static schedule. This is not supposed to be used
#'         with alerts, but is provided for completeness. (path: `informed_entity.trip.schedule_relationship`).
